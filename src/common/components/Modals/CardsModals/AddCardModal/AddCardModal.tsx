...
const AddCardModal:FC<AddCardModalType> = ({packId}) => {
    ...
    return (
        <BasicModal children2={<SuperButton disabled={status === 'loading'}
                ...
                <div>
                    ...
                    <div className={s.textField}>
                        <TextField value={question} variant="standard" label="Question" placeholder="Write a name"
                                   sx={{width: '100%', margin: '10px 0'}} helperText='Write a Question' onChange={changeQuestionNameHandler}/>
                        <TextField value={answer} variant="standard" label="Answer" placeholder="Write a name"
                                   sx={{width: '100%', margin: '10px 0'}} helperText='Write an Answer' onChange={changeAnswerNameHandler}/>
                    </div>
